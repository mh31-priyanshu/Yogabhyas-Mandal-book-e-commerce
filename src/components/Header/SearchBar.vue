...
<template>
<div class="relative">
    <svg class="pointer-events-none w-8 h-5 absolute top-1/2 transform -translate-y-1/2 left-3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 90 90" width="90px" height="80px">
        <g id="surface1552061">
